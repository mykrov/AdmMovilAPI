...
class Cliente extends Model
{
   ...
   // protected $dateFormat = 'M j Y h:i:s';
     ...
     * @var array
     */
    protected $fillable = ['RAZONSOCIAL', 'NEGOCIO', 'REPRESENTA', 'RUC', 
    'DIRECCION', 'TELEFONOS', 'FAX', 'EMAIL', 'TIPO',
    'CATEGORIA', 'PROVINCIA', 'CANTON', 'PARROQUIA',
    'SECTOR', 'RUTA', 'CTACLIENTE', 'CUPO', 'GRUPO', 
    'ORDEN', 'CODFRE', 'CREDITO', 'DIA', 'FECDESDE','FECHAING',
    'FECULTCOM', 'FECELIMINA', 'ESTADO', 'TDCREDITO', 'DIASCREDIT', 
    'VENDEDOR', 'FORMAPAG', 'CREDITOA', 'IVA', 'BACKORDER', 'RETENPED', 
    'CONFINAL', 'CLASE', 'OBSERVACION', 'TIPONEGO', 'CODTMP', 'TIPODOC', 
    'tipocuenta', 'CLIENTEWEB', 'CODCLIENTEDOMI', 'CLIENTEDOMI', 
    'REFERENCIA', 'TIPOCONTRIBUYENTE', 'RETIENEFUENTE', 'RETIENEIVA', 
    'ZONA', 'FECNAC', 'FECMOD', 'OPEMOD', 'PORDESSUGERIDO', 
    'EMAILSECUNDARIO', 'fechaenvioweb', 'FACTURAELECTRONICA', 
    'CLAVEFE', 'SUBIRWEB', 'TIPOPERSONA', 'SEXO', 'ESTADOCIVIL', 
    'ORIGENINGRESO', 'TIPOPAGO', 'FECHADESDE', 'FECHAHASTA', 'BENEFICIARIO',
    'NOCONTRATO', 'TIPOPERSONAADICIONAL', 'GERENTE', 'TELEFONO',
    'CONTACTOPAGO', 'CORREO1', 'CORREO2', 'CARGO1', 'CARGO2', 
    'OBSERVACIONADICIONAL', 'PAGOCUOTAS', 'NUMCUOTAS', 'CUOTA1', 
    'CUOTA2', 'CUOTA3', 'CUOTA4', 'CUOTA5', 'EJEX', 'EJEY', 
    'CLIENTEMOVIL', 'ESTADOPARAWEB', 'CLIRELACIONADO', 
    'VENDEDORAUX', 'CANAL', 'SUBCANAL', 'grupocliente',
    'grupocredito', 'EWEB', 'nombre', 'FACTURABLE', 
    'DEUDAS', 'ANTICIPO', 'CIUDAD', 'coordenada', 'barrio', 
    'tipodocumento', 'CODIGOSAP', 'CodShip', 'longuitud', 'latitud',
    'TipoLocalidad', 'numero', 'CORREOCARRO', 'CLAVECARRO','ESCREDITO'];
